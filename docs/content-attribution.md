...
## SRD 5.2.1 standardization initiative (slices 141 to 149, completed)

Slices 141 through 149 standardized the monster cohort against SRD 5.2.1. The audit script + the resulting per-monster diff record live at [docs/srd-5.2.1-audit.md](srd-5.2.1-audit.md).
...
- **Magic items** (138 entries). Spans common through legendary. The SRD 5.2.1's magic-item A-Z lists ~250 entries; the pack is a 138-entry subset. No individual cross-reference has been performed; the high-confidence consumer move is to apply the same audit-script pattern used on monsters.
