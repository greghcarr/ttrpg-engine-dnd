...
The fixed vocabulary the engine reads to compute character state. 46 kinds; see `EFFECT_KINDS` in [src/schemas/effects.ts](../src/schemas/effects.ts) for the canonical list. Highlights:
