...
- **Paladin**: ~~Paladin's Smite (L2)~~ (slice 210: dedicated planPaladinsSmite — bonus-action slot-spend, emits radiant DamageApplied chained to a triggering hit; +1d8 Undead/Fiend), Aura Expansion (L18)
