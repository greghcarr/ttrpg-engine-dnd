...
About 17 main-class features at slice 196; slices 199-221 closed 16 of them: Rogue L5 + L18 (slices 200, 199), Sorcerer L7 alt-cost arm (slice 201), Monk L6 + L10 + L14 + L18 (slices 207, 202, 203, 209), Ranger L9 (slice 208), Paladin L2 + L18 (slices 210, 211), Cleric L1 + L10 + L20 (slices 214, 220, 221), Druid L1 (slice 215), Bard L20 + Warlock L9 (slice 216). **Two remain deferred with multi-slice prerequisites** (annotated inline below): Monk L10 Heightened Focus (needs Flurry of Blows / Patient Defense / Step of the Wind planners first), Ranger L17 Precise Hunter (needs Hunter's Mark planner + a new `GrantAdvantageVsBearersOfMyCondition` primitive). The doubled-metamagic arm of Sorcery Incarnate and the 2d4-LR cooldown arm of Greater Divine Intervention are also still deferred (needs once-per-spell metamagic enforcement and a `ResourceCooldownExtended` primitive respectively).
