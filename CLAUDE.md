...
When working in this repo, the slice cadence is "primitive + canonical user": one focused primitive plus the first one or two RAW spells / features that exercise it. See recent slices (88–121) for the pattern.
