...
| Monster statblocks | 118 | ~370 (MM) | 🟡 | All 14 MM creature types now in pack: Humanoid, Beast, Undead, Giant, Dragon, Fiend, Elemental, Monstrosity, Ooze, Construct, Aberration, Fey, Celestial, Plant. CR 0 (Awakened Shrub, Lemure, Commoner) to CR 21 (Solar). 12 statblocks with wired Recharge area-save Breath Weapons (all dragons + Iron Golem + Ankheg, since slice 140), 5 with Legendary Actions and Resistance (Beholder, Aboleth, 5 Adult Chromatics), 17 with Magic Resistance (wired since slice 131). Highest-leverage remaining engine primitives are Legendary Actions / Resistance, Frightful Presence, Innate Spellcasting per-spell envelope, Charge / Pounce / Trampling, and an unconditional elemental rider on bite. |
