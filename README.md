...
|---|---|---|---|---|
| Classes (table scaffolding) | 12 of 12 | 12 | 🟡 | Tables ship 1-20. Class-feature wire status (per the coverage matrix): **34 wired / 14 stub** at L1-5. Wired highlights: Sneak Attack scaling all 10 odd levels, Second Wind / Action Surge / Extra Attack, Rage resource, Bardic Inspiration, Channel Divinity, Wild Shape, Monk's Focus / Unarmored Defense / Extra Attack, Hunter's Mark + Weapon Mastery grant, Innate Sorcery / Font of Magic / Sorcerous Restoration, Lay on Hands, Arcane Recovery, Barbarian Unarmored Defense + Danger Sense. Stubs (engine work not yet done): Martial Arts die scaling, Stunning Strike, Reckless Attack timing, Metamagic, Evasion, Druidic, Slow Fall, Cutting Words, etc. — flagged individually in the feature-coverage matrix. |
