...
| Magic items | `█████░░░░░░░░░░░░░░░` 🟥 ~24% | 47 items across uncommon / rare / very-rare / legendary tiers; bulk of DMG catalog deferred |
| Monsters | `███░░░░░░░░░░░░░░░░░` 🟥 ~13% | 49/~370 MM statblocks across Humanoid / Beast / Undead / Fiend (single largest content gap by count) |
...
| Magic items | 47 | hundreds (DMG) | 🟡 | Spans uncommon / rare / very-rare / legendary tiers (broadened past Deck of Many Things in items batches 1.5–1.6). Includes the original alpha.5 set (Bag of Holding, Wand of Magic Missiles, Cloak of Protection, etc.), the wondrous fillout from items batches 1.1–1.6, the +1 / +2 / +3 weapon and armor templates, plus six consumable potions. Bulk DMG items still deferred; most blocked on the same magic-item-effects-projection gap. |
| Monster statblocks | 49 | ~370 (MM) | 🟡 | Four creature types in pack: Humanoid (NPC roster + 4 caster NPCs from monsters batches 1.1–1.4), Beast (low-CR ambient threats from batches 1.2 and 1.5), Undead (haunted-location roster from batch 1.6: Shadow, Specter, Wight, Ghost, Wraith), Fiend (low-CR introduction in batch 1.7: Manes, Lemure, Dretch, Imp, Quasit). Most MM creatures still missing. The single largest content gap by raw count. |
