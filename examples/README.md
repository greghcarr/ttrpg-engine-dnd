...
The examples import from `../../src/index.js` because they live inside this repo. In a downstream consumer you would import from `'dnd-srd-engine'` instead; everything else is identical.
